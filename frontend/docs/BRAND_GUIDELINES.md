...
|------------|----------|-----|-------|
| Cyberpunk Blue | `#00f2ff` | 0, 242, 255 | Primary brand color, CTAs, highlights |
| Cyberpunk Purple | `#a855f7` | 168, 85, 247 | Secondary actions, accents |
| Cyberpunk Pink | `#ec4899` | 236, 72, 153 | Alerts, notifications, emphasis |

### Neutral Colors
| Color Name | Hex Code | RGB | Usage |
|------------|----------|-----|-------|
| Dark Background | `#0a0a0a` | 10, 10, 10 | Primary background |
| Card Background | `#1a1a1a` | 26, 26, 26 | Surface backgrounds |
| Gray 800 | `#1f1f1f` | 31, 31, 31 | Secondary surfaces |
| Gray 700 | `#373737` | 55, 55, 55 | Borders, dividers |
| Gray 600 | `#4b4b4b` | 75, 75, 75 | Hover states |
| Gray 500 | `#6b6b6b` | 107, 107, 107 | Disabled states |
| Gray 400 | `#9ca3af` | 156, 163, 175 | Secondary text |
| Gray 300 | `#d1d5db` | 209, 213, 219 | Tertiary text |
...
| Error | `#ef4444` | 239, 68, 68 | Error states, critical alerts |
...
| Weight | Usage |
|--------|-------|
| 300 (Light) | Large headings, decorative text |
| 400 (Regular) | Body text, default weight |
| 500 (Medium) | Subheadings, emphasis |
| 600 (SemiBold) | Section titles, important UI elements |
...
| Body Large | 1.125rem | 18px | Primary body text |
