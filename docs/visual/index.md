...
## Digital Soul: arch_brain.json

The canonical architectural state, epochs, and protein mappings are maintained in:

* `docs/arch_brain.json` — Bootstrap prompt for AI agents, trauma log, protein-to-settings mappings

**Current Epoch:** Binary Bloodstream (Proto-as-Source-of-Truth)

All NATS events use binary Protobuf serialization. Generated code lives in `packages/aura-core/src/aura_core/gen/`.
